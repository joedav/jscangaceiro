System.register(['./Bind.js', './ConnectionFactory.js', './DaoFactory.js', './ApplicationException.js', './HttpService.js', './ProxyFactory.js', './decorators/Debounce.js', './decorators/Constroller.js', './Obrigatorio.js', './decorators/BindEvent.js'], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_BindJs) {
      ...
      _export(_exportObj7);
    }, function (_decoratorsConstrollerJs) {
      var _exportObj8 = {};

      for (var _key8 in _decoratorsConstrollerJs) {
        if (_key8 !== "default" && _key8 !== "__esModule") _exportObj8[_key8] = _decoratorsConstrollerJs[_key8];
      }
